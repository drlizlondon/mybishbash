...
revoke execute on function public.redeem_mybishbash_signup_handoff(text, uuid, text) from public;
grant execute on function public.redeem_mybishbash_signup_handoff(text, uuid, text) to authenticated;
