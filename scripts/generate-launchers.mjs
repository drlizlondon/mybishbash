    ...
    <main class="install-shell">
      ...
      <section class="install-card">
        ...
        <div class="install-copy">
          <h2>Add <span data-version-name>${escapeHtml(launcher.displayName)}</span> to your Home Screen</h2>
          <p>Add this launcher to your Home Screen. When you open it, MyBishBash will show your Personal Cards before <span data-version-name-inline>${escapeHtml(launcher.displayName)}</span>.</p>
        </div>
        ...
        <div class="install-success" data-install-success hidden>
          ...
          <p>Open your new <span data-version-name-inline>${escapeHtml(launcher.displayName)}</span> launcher from your Home Screen. If asked, log in to MyBishBash, then you’ll start seeing your Personal Cards before <span data-version-name-inline>${escapeHtml(launcher.displayName)}</span> opens.</p>
        </div>
      </section>
    </main>
