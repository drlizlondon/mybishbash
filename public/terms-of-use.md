...
- create harmful or dangerous content
- interfere with the operation of the service

We may restrict or remove content or access that violates these principles.
...
You remain responsible for your own decisions, wellbeing, and actions.

If you are experiencing a mental health crisis or emergency, please contact an appropriate healthcare professional or emergency service.
...
We aim to improve the experience continuously.
...
- personal decisions made while using the app

Nothing in these Terms limits rights that cannot legally be excluded under applicable law.

---

# Termination

We may suspend or terminate access if these Terms are violated or if misuse of the platform occurs.
